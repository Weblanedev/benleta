  ...
  return (
    <div>
      <div className="relative ">
        <h1 className="text-3xl md:text-6xl xl:text-7xl font-semibold my-8  md:my-16 text-[#132D46]">
          Privacy Policy
        </h1>
      </div>
      ...
      <p className="text-xl md:text-2xl font-semibold mt-7 mb-5 text-[#132D46]">
        Interpretation
      </p>
      <p className="text-[#111111] font-general">
      ...
      <ul className="list-disc pl-8 font-general text-[#111111] flex flex-col gap-4">
        <li>
          <b className="font-bold font-poppins">Account </b> means a unique
          account created for You to access our Service or parts of our Service.
        </li>
        <li>
          <b className="font-bold font-poppins">Affiliate </b> means an entity
        ...
        <li>
          <b className="font-bold font-poppins">Application </b> refers to Taja,
          the software program provided by the Company.
        </li>
        <li>
          <b className="font-bold font-poppins">Company </b> (referred to as
          either "the Company", "We", "Us" or "Our" in this Agreement) refers to
          Itaja Innovations Limited, 180 Freedom Way, Lekki, Lagos.
        </li>
        <li>
          <b className="font-bold font-poppins">Country </b> refers to: Nigeria
        </li>
        <li>
          <b className="font-bold font-poppins">Device </b> means any device
          that can access the Service such as a computer, a cellphone or a
          digital tablet.
        </li>
        <li>
          <b className="font-bold font-poppins">Personal Data </b> is any
          information that relates to an identified or identifiable individual.
        </li>
        <li>
          <b className="font-bold font-poppins">Service </b> refers to the
          Application.
        </li>
        <li>
          <b className="font-bold font-poppins">Service Provider </b> means any
        ...
        <li>
          <b className="font-bold font-poppins">Usage Data </b> refers to data
        ...
        <li>
          <b className="font-bold font-poppins">You </b> means the individual
      ...
      <p className="text-2xl md:text-3xl font-bold mt-10 mb-3 text-[#132D46]">
        Collecting and Using Your Personal Data
      </p>
      <p className="text-xl md:text-2xl font-bold mt-4 mb-3 text-[#132D46]">
        Types of Data Collected
      </p>
      <p className="text-lg md:text-xl font-bold mt-4 mb-5 text-[#132D46]">
        Personal Data
      </p>
      <p className="text-[#111111] font-general mb-4">
      ...
      <p className="text-lg md:text-xl font-semibold mt-6 mb-5 text-[#132D46]">
        Usage Data
      </p>
      <p className="text-[#111111] font-general my-4">
      ...
      <ul className="list-disc pl-8 font-general text-[#111111] flex flex-col gap-4">
        <li>
          <b className="font-bold font-poppins">
            To provide and maintain our Service,
          </b>{" "}
          including to monitor the usage of our Service.
        </li>
        <li>
          <b className="font-bold font-poppins">To manage Your Account: </b> to
        ...
        <li>
          ...
          refers to Taja, the software program provided by the Company.
        </li>
        <li>
          <b className="font-bold font-poppins">To contact You: </b> To contact
        ...
        <li>
          <b className="font-bold font-poppins">To provide You </b> with news,
        ...
        <li>
          <b className="font-bold font-poppins">To manage Your requests: </b> To
          attend and manage Your requests to Us.
        </li>
        <li>
          <b className="font-bold font-poppins">For business transfers: </b> We
        ...
        <li>
          <b className="font-bold font-poppins">For other purposes: </b> We may
      ...
      <p className="text-[#111111] font-general my-5">
        We may share Your personal information in the following situations:
      </p>
      <ul className="list-disc pl-8 font-general text-[#111111] flex flex-col gap-4">
        <li>
          <b className="font-bold font-poppins">With Service Providers:</b> We
        ...
        <li>
          <b className="font-bold font-poppins">With Affiliates: </b> We may
        ...
        <li>
          <b className="font-bold font-poppins">With business partners: </b> We
          may share Your information with Our business partners to offer You
          certain products, services or promotions.
        </li>
        <li>
          <b className="font-bold font-poppins">With other users: </b> when You
        ...
        <li>
          <b className="font-bold font-poppins">With Your consent: </b> We may
          disclose Your personal information for any other purpose with Your
          consent.
        </li>
      </ul>
      <p className="text-xl md:text-2xl font-bold mt-5 mb-5 text-[#132D46] font-poppins">
      ...
      <p className="text-xl md:text-2xl font-bold mt-5 mb-4 text-[#132D46]">
        Disclosure of Your Personal Data
      </p>
      <p className="text-lg md:text-xl font-bold mt-5 mb-5 text-[#132D46]">
      ...
      <p className="text-2xl md:text-3xl font-semibold my-5 text-[#132D46]">
        Children's Privacy
      </p>
      <p className="text-[#111111] font-general my-4">
      ...
      <ul className="list-disc pl-8 font-general text-[#111111] flex flex-col gap-4">
        <li>By email: <Link href={'mailto: hello@buytaja.com'}>hello@buytaja.com</Link></li>
        <li>By visiting this page on our website: <Link href={'https://tajahq.com/'} className="text-[blue] underline ">tajahq.com</Link></li>
      </ul>
    </div>
  );
};
