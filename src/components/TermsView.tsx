  ...
  return (
    <div>
      <div className="relative ">
        <h1 className="text-3xl md:text-6xl  xl:text-7xl font-semibold my-16 text-[#132D46] font-poppins">
          Terms and Conditions
        </h1>
      </div>

      <p className="text-[#111111] font-general">
        Welcome to taja!
        <br />
        <br />
        These terms and conditions outline the rules and regulations for the use
        of Itaja Innovations Limited's Website, located at tajahq.com.
        <br />
        <br />
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Taja if you do not agree to take all
      ...
      <p className="text-2xl md:text-3xl font-semibold mt-10 mb-5 text-[#132D46]">
        Cookies
      </p>
      <p className="text-[#111111] font-general mb-5">
        We employ the use of cookies. By accessing Taja, you agreed to use
        cookies in agreement with the Itaja Innovations Limited's Privacy
        Policy.
      </p>
      <p className="text-[#111111] font-general mb-5">
      ...
      <p className="text-[#111111] font-general mb-5">
        Unless otherwise stated, Itaja Innovations Limited and/or its licensors
        own the intellectual property rights for all material on taja. All
        intellectual property rights are reserved. You may access this from taja
        ...
        <ul className="list-disc pl-8 flex flex-col gap-4 text-[#111111] font-general">
          <li>Republish material from taja</li>
          <li>Sell, rent or sub-license material from taja</li>
          <li>Reproduce, duplicate or copy material from taja</li>
          <li>Redistribute content from taja</li>
        </ul>
        <p className="text-[#111111] font-general mb-5">
        <br />
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Itaja
        Innovations Limited does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Itaja Innovations Limited ,its agents and/or
        ...
        laws, Itaja Innovations Limited shall not be liable for the Comments or
        ...
        <br />
        <br />
        Itaja Innovations Limited reserves the right to monitor all Comments and
        ...
        <p className="text-[#111111] font-general mb-5">
        <br />
        You hereby grant Itaja Innovations Limited a non-exclusive license to
        use, reproduce, edit and authorize others to use, reproduce and edit any
        of your Comments in any and all forms, formats or media.
      </p>
      <p className="text-2xl md:text-3xl font-semibold mt-7 mb-5 text-[#132D46]">
      ...
      <p className="text-[#111111] font-general mb-5">
        ...
        the hyperlink compensates the absence of Itaja Innovations Limited ; and
        ...
        e-mail to Itaja Innovations Limited . Please include your name, your
        ...
        <p className="text-[#111111] font-general mb-5">
        <br />
        No use of Itaja Innovations Limited 's logo or other artwork will be
      ...
      <p className="text-xl md:text-3xl font-semibold mt-7 mb-5 text-[#132D46]">
        Content Liability
      </p>
      <p className="text-[#111111] font-general">
      ...
      <p className="text-xl md:text-3xl font-semibold mt-10 mb-5 text-[#132D46]">
